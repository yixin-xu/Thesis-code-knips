...
code_directory <- "Thesis code/Code/CTMM-spline function"
...
tmat <- rbind(c(NA, 1, NA, NA, NA, NA, 8, 13), # From "Post TKR"
              c(NA, NA, 2, 3, 4, NA, NA, NA), # From "Post 1st revision"
              c(NA, NA, NA, NA, NA, 5, 9, 14), # From "Post 2nd revision"
              c(NA, NA, NA, NA, NA, 6, 10, 15), # From "Surgery Death" (i.e., no transitions)
              c(NA, NA, NA, NA, NA, 7, 11, 16),
              c(NA, NA, NA, NA, NA, NA, 12, 17),
              c(NA, NA, NA, NA, NA, NA, NA, NA),
              c(NA, NA, NA, NA, NA, NA, NA, NA)) # From "Death" (i.e., no transitions)
...
write.csv(results_table, file = paste0("Thesis code/Results/CTMM-spline function/"
                                       , sample_gender, "_", age_range[1], "-",age_range[2],"_s",n_samples, "_p", n_patients,".csv"))

# Plots a CEAC 
jpeg(filename = paste0("Thesis code/Results/CTMM-spline function/",
