...
generate_net_benefit <- function(input_parameters, lambda = 20000) {
  ...
  # Assume everyone starts in the post_thr state except the background mortality
  ...
  primary_mortality <- rbeta(n_samples, shape1 = tkr_mortality_90d_beta_params[1], shape2 = tkr_mortality_90d_beta_params[2])
