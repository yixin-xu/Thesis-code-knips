generate_cost_utility_models <- function(n_samples, 
  ...
  #rcs_first_revision_temp <-rcs_first_revision$`Cem CR_Fix Mono`
  #ln_bhknots_first_revision_temp <-ln_bhknots_first_revision$`Cem CR_Fix Mono`
  #for(time_start_ in 0:(n_times - 1)) {
  #  spline_hazard = hsurvspline(
  #    x = time_start_,
